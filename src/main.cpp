...
unsigned int nStakeMinAge = 60 * 60;	// time at which weight begins to build
unsigned int nStakeMinAgeV2 = 60 * 60;	// functionally the minimum age is 8.8 days
unsigned int nStakeMaxAge = 60 * 60 * 10;	// stake age of full weight: -1
unsigned int nStakeTargetSpacing = 90;			// 90 sec block spacing

int64 nChainStartTime = 1423889047;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x096b24997c0cd6c124ca7fb8f031ba9865fdc8efa6d344171a41e13625bcf0cd"));
